...
public class AutonomousMaze extends SequentialCommandGroup {
  /**
   ...
   */
  public AutonomousMaze(Drivetrain drivetrain) {
    addCommands(
      new DriveDistanceT(0.4,(0.4*.98),.5, drivetrain),
      new DriveDistanceT(0.7,(0.7*.98),4.5, drivetrain),
      new DriveCurve(0.6,-.83,16.5, drivetrain),
      new DriveDistanceT(0.7,(0.7*.98),3, drivetrain),
      new DriveCurve(0.6,-.53,8.5, drivetrain),
      new DriveDistanceT(0.7,(0.7*.98),17, drivetrain),
